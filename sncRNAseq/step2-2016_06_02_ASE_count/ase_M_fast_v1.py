...
# fixed error from ase_M_fast.py
# usage: ase_M_fast_v1.py all_sam_order.list accepted_hits_uniq_chr_M.sorted.sam > accepted_hits.ase
# list and sam file should be in coordinate order (sam_order/ samtools sort)
...
#    if line_sam == "" and not line_list:  ## line_list --> cannot be empty, make list without '' line
#        data_sam.close()
#        break
...
#    if line_sam == "" and line_list:   ## line_list --> cannot be empty, make list without '' line
    if line_sam == "":
